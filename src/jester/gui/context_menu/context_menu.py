...
def create_file_copy_node(graph):
    graph.create_node("jester.core.FileCopyNode")

def create_media_encode_node(graph):
    graph.create_node("jester.core.MediaEncodeNode")

def create_metadata_node(graph):
    graph.create_node("jester.core.MetadataNode")

def create_file_rename_node(graph):
    graph.create_node("jester.core.FileRenameNode")

def create_media_source_node(graph):
    graph.create_node("jester.core.MediaSourceNode")

def create_show_properties_node(graph):
    node = graph.create_node("jester.core.ProjectPropertiesNode")
    graph.node_created.emit(node)

def create_tag_node(graph):
    graph.create_node("jester.core.TagNode")